<x-app-layout>
    ...
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight"> graveyards </h2>
        ...
        <div class="md:flex no-wrap md:-mx-2 ">
            ...
            <div class="w-full md:w-3/12 md:mx-2 rounded">
                ...
                <div class="bg-white p-3 border-t-4 border-blue-400">
                    ...
                    <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">{{ $graveyard->name }} graveyard</h1>
                    ...
                    <ul
                        ...
                        <li class="flex items-center py-3">
                            ...
                            <span class="ml-auto"><span
                                    class="bg-blue-500 py-1 px-2 rounded text-white text-sm">{{ $graveyard->sections->count() }}</span>
                        </li>
                        <li class="flex items-center py-3">
            ...
            <div class="w-full md:w-9/12 mx-2 h-64">
                ...
                <div class="bg-white p-3 shadow-sm rounded">
                    <div class="flex items-center space-x-2 font-semibold text-gray-900 leading-8">
                        ...
                        <span class="tracking-wide">{{ $graveyard->name }}</span>
                    </div>
                                ...
                                <div class="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg">
                                    <table class="min-w-full divide-y divide-gray-300">
                                        ...
                                        <tbody class="divide-y divide-gray-200 bg-white">
                                            @foreach ($graveyard->sections as $sections)
                                                <tr>
                                                    <td
